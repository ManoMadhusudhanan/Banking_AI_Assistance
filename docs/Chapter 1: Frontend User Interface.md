...
Let's move on to discover how your message travels from the Frontend to the AI's core logic in the next chapter: [Chatbot API and Orchestration](https://github.com/ManoMadhusudhanan/Banking_AI_Assistance/blob/main/docs/Chapter%202%3A%20Chatbot%20API%20and%20Orchestration.md).
